...
@section('title', 'Kerala State Lotteries | Ticket Booking Details')
...
@section('content')
  ...
  <div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
    <div class="booking-card">
      <h3 class="text-center title-header" style="color: #007adf !important;">Ticket Booking Details</h3>
      ...
      <p class="mt-2 text-dark mb-4" style="font-size: 1rem;">
          Total Tickets: <b class="text-primary" style="font-size: 1.1rem;">{{ $total_tickets }}</b>
      </p>
      
      <form action="{{ route('book-ticket.submit') }}" method="POST" onsubmit="return validateForm()">
        @csrf
        <!-- ✅ HIDDEN INPUT -->
        <input type="hidden" name="ticketno" value="{{ $ticket_param }}">
        ...
        <!-- TERMS -->
        <div class="form-group form-check mb-4 text-left">
          ...
          <label class="form-check-label agree-text ml-2" for="terms" style="cursor: pointer; user-select: none;">
            I agree to <a href="{{ route('about') }}" target="_blank">Terms & Conditions</a> & <a href="{{ route('about') }}" target="_blank">Privacy Policy</a>
          </label>
        </div>
      ...
      <div class="text-center footer-links">
        <a href="{{ route('buy-tickets') }}">Change Ticket</a>
        <span>|</span>
